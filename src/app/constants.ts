...
/** Google reviews: replace with your Google Business “Get more reviews” / Maps reviews URL when you have it. */
...
export const PROJECTS: Project[] = [
  {
    ...
    description: [
      'A premium eco-cleaning brand and website designed to blend luxury service and seemless technology. The site includes a custom quote calculator and booking flow so visitors can go from “curious” to “scheduled” in a few clicks.',
  ...
  },
  {
    ...
    description: [
      'A calm, immersive website designed and built for a sound healer and facilitator offering group journeys, private sessions, and in-person events.',
